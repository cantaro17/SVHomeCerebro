				...
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">Nombre:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
								<tr>
									<td class="profile">Dirección:</td><td class="profile"><?php echo $fetch['address'];?></td>
								</tr>
								<tr>
									<td class="profile">País:</td><td class="profile"><?php echo $fetch['country'];?></td>
								</tr>
								<tr>
									<td class="profile">Código postal:</td><td class="profile"><?php echo $fetch['zipcode'];?></td>
								</tr>
								<tr>
									<td class="profile">Número de teléfono móvil:</td><td class="profile"><?php echo $fetch['mobile'];?></td>
								</tr>
								<tr>
									<td class="profile">Número de teléfono:</td><td class="profile"><?php echo $fetch['telephone'];?></td>
								</tr>
								<tr>
...
<div id="container">
	<div class="nav">	
			 <ul>
				<li><a href="home.php">   <i class="icon-home"></i>Casa</a></li>
				<li><a href="product1.php"> 			 <i class="icon-th-list"></i>Producto</a></li>
				<li><a href="aboutus1.php">   <i class="icon-bookmark"></i>Sobre noso0tros</a></li>
			</ul>
	</div>
...
?>
	...
	<a href='product1.php' class='btn btn-inverse btn-lg'>Seguir comprando</a>
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">HomeCerebro</p>
		</div>
			
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="https://www.facebook.com/tusolutionweb/"><li>Facebook</li></a>
						<a href="https://twitter.com/tusolutionweb"><li>Twitter</li></a>
