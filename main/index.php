...
?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Home Cerebro</center></font>
<div id="mainmain">
...
<a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Reporte ventas</a>
<a href="../index.php"><font color="red"><i class="icon-off icon-2x"></i></font><br> Cerrar sesión
</a> 
<?php
}
?>
